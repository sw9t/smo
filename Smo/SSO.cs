...
namespace Smo
{
    public class SSO
    {
        ...
        private static string Smo_s_neogranicennoi_label(double lambda, double t_obslujivania, double max_oceredi_r, double n_kanalov, double[] massP, double r, double ro, double ro_stationar)
        {
            string label;
            label = "Ответ: ";
            ...
            label+="\r\nСреднее время пребывания с учетом ожидания и обслуживания"ж
